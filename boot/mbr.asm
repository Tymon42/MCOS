...
section mbr vstart=0x7c00
	...
	flush:
		...
		mov eax,final_mem_kernel_adress
		xor esi,esi
		mov ecx,166400
			
		.clear_mem:
			mov dword [eax+esi*4],0x0000_0000
			inc esi
			loop .clear_mem
		
			
		mov edx,final_mem_buffer
		add edx,52
		
		mov eax,[edx+8]
		sub eax,0x8000_0000
		mov edi,eax
		mov eax,final_mem_buffer
		mov esi,eax
		mov ecx,[edx+16]
		...
		jmp dword [final_mem_kernel_adress+24]
